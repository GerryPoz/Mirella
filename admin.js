...
function renderCategoriesTable() {
    ...
    tbody.innerHTML = categories.map(category => `
        <tr>
            <td>
                ${category.image ? 
                    `<img src="${category.image}" alt="${category.name}" style="width: 30px; height: 30px; object-fit: cover; border-radius: 50%; margin-right: 10px; vertical-align: middle;">` : 
                    '📦 '
                }
                ${category.name}
            </td>
    ...
    tbody.innerHTML = products.map(product => {
        ...
        return `
            <tr>
                <td>
                    ${product.image ? 
                        `<img src="${product.image}" alt="${product.name}" style="width: 30px; height: 30px; object-fit: cover; border-radius: 50%; margin-right: 10px; vertical-align: middle;">` : 
                        '📦 '
                    }
                    ${product.name}
                </td>
